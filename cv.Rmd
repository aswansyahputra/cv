...
Experienced Data Analyst with a robust background in Sensory Science and Food Technology. Specializes in data analytics, visualization, R programming, analytical web applications, and AI automation. Proven track record in enhancing decision-making through insightful data analysis in food-tech, gov-tech, and edu-tech domains.

# Professional Experience

## Data & AI Manager, **Sekolah.mu**

*Jakarta, Indonesia • Jul 2025 – Present*

- Lead the strategic direction of Sekolah.mu’s data and AI initiatives.
- Ensure seamless integration of scalable pipeline architectures, advanced analytics, and cutting-edge AI/ML systems.
- Collaborate with cross-functional teams to inform and achieve business growth goals.

## Senior Data Analyst, **Sekolah.mu**

*Jakarta, Indonesia • Aug 2021 – Jun 2025*
...
- Statistics in Food Industry: a glimpse into Sensometrics
- Utilizing Memoization Technique in Function and API Calls
- Data Analytics with Python
- Empowering Healthcare Data Workflows with R
